<script>
    ...
    export let wrapperClass = "text-tomato bg-transparent";
    export let loaderClass = "text-tomato w-[1em] h-[1em] text-xs";
</script>

<div class="wrapper {wrapperClass}" transition:fade>
    <h1>
        <div class="loader {loaderClass}" />
    </h1>
</div>

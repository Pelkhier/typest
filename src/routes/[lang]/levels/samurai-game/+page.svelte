...
<div class="inline-block relative overflow-hidden force-left-to-right">
    {#if gameState === "game over"}
        ...
        <div
            ...
            class:force-right-to-left={$page.data.lang === "ar"}
        >
            <div class="result relative flex flex-col justify-between">
                <div
                    class="return-home absolute z-50 {$page.data.lang === 'en'
                        ? 'right-10'
                        : 'left-10'}"
                >
                    <button
                    ...
                    >
                        <iconify-icon icon="heroicons:home-solid" />
                    </button>
                </div>
